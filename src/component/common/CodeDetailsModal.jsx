              ...
              <label key={check.name} className="flex items-center gap-2.5 cursor-pointer group select-none">
                <div className="relative flex items-center justify-center">
                  <input
                    ...
                    onChange={handleChange}
                    className="peer appearance-none w-4 h-4 rounded border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 checked:bg-pink-500 checked:border-pink-500 transition-all duration-200 cursor-pointer shadow-sm"
                  />
                  <svg
