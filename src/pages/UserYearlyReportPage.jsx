      ...
      <div className="flex-1 w-full bg-white dark:bg-[#161920] border border-slate-200 dark:border-slate-800/50 shadow-sm flex flex-col rounded-3xl text-black">
        ...
        <div className="flex flex-col gap-6 py-8 px-4 md:px-8 transition-colors border-b border-slate-100 dark:border-slate-800/50 text-black">
          <nav className="flex items-center gap-1.5 text-[10px] uppercase font-bold tracking-widest text-black mb-1">
            ...
            <span className="text-black">/</span>
            <span className="text-black font-black">User Yearly Report</span>
          </nav>
        ...
        {/* Filter Section */}
        <div className="px-4 md:px-8 py-5 flex items-end gap-4 text-black">
          <div className="flex flex-col gap-2 w-[200px] text-black">
            <label className="text-[10px] font-black text-black uppercase tracking-widest ml-1">Year</label>
            <select
              value={filters.year}
              onChange={(e) => setFilters({ ...filters, year: e.target.value })}
              className="px-3 py-2 text-xs bg-white dark:bg-slate-900/50 border border-slate-200/60 dark:border-slate-800/50 rounded-xl outline-none focus:border-black transition-all w-full font-semibold text-black shadow-sm"
            >
